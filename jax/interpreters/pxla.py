...
ShardingSpec.mesh_shape = property(mesh_shape)
ShardingSpec.sharding_proto = sharding_proto
ShardingSpec.indices = indices
# mypy raises: error: Cannot assign to a method  [assignment]
ShardingSpec.__repr__ = __repr__  # type: ignore
# Do not pollute the namespace
del mesh_shape, indices, __repr__
